...
# Функція переведення дюймів у сантиметри
def inches_to_cm(inches):
    """
    Функція переводить дюйми у сантиметри.

    Аргументи:
    inches (float) - значення у дюймах

    Повертає:
    float - значення у сантиметрах
    """
    return inches * 2.54
